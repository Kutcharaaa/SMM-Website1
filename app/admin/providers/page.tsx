...
export default function AdminProvidersPage() {
  ...
  const [importedServices, setImportedServices] =
    useState<ImportedService[]>([]);
  ...
  async function importServices(provider: Provider) {
    try {
      const response = await fetch(
        "/api/admin/providers/import-services",
        {
          method: "POST",
          headers: {
            "Content-Type":
  ...
  const filteredServices =
    importedServices.filter((service) =>
      service.name
        .toLowerCase()
      ...
      <section className="lg:ml-72 min-h-screen">
                ...
                {editingProvider ? (
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 bg-blue-600 hover:bg-blue-700 rounded-xl px-4 py-3 font-semibold transition"
                    >
                      Save Changes
                    </button>
                  ...
                  <button
                    onClick={addProvider}
                    className="w-full bg-blue-600 hover:bg-blue-700 rounded-xl px-4 py-3 font-semibold transition"
                  >
                    Add Provider
                  </button>
                )}
        ...
        {importModal && (
          <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-6">
            <div className="w-full max-w-6xl rounded-3xl border border-zinc-800 bg-zinc-950 overflow-hidden">
