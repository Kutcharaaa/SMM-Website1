        ...
        <div className="relative z-10 mx-auto max-w-7xl px-5 py-14 lg:px-8 lg:py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-base font-medium leading-7 text-slate-600 md:text-lg">
              Access your dashboard, manage orders, and grow your social media
              presence.
            </p>
          </div>
                ...
                {[
                  ...
                  return (
                    <button
                      ...
                      type="button"
                      disabled
                      title={`${item.name} login not enabled yet`}
                      className="flex h-14 items-center justify-center rounded-2xl border border-slate-200 bg-white text-slate-500 opacity-70"
                    >
                      <Icon size={23} />
                    </button>
                  );
