...
export default function DashboardTopbar({ onMenuClick }: DashboardTopbarProps) {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-slate-200 bg-[#f8fbff]/95 backdrop-blur">
      <div className="flex min-h-20 w-full min-w-0 items-center justify-between gap-2 px-3 sm:gap-3 sm:px-4 lg:min-h-24 lg:px-8">
      ...
      <div className="border-t border-slate-100 bg-white/60 px-4 py-2 md:hidden">
        <div className="flex min-w-0 items-center justify-between gap-3">
          ...
          <p className="min-w-0 truncate text-sm font-black text-blue-600">
            {formatAmount(balance)}
          </p>
        </div>
      </div>
